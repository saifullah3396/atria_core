...
from atria_core.types.generic._tensor.annotated_object import TensorAnnotatedObject
...
class TensorOCRGT(TensorDataModel["OCRGT"]):
    ...
    word_bboxes: list[TensorBoundingBox] | None = None
...
class TensorSERGT(TensorDataModel["SERGT"]):
    ...
    words: list[str] | None = None
    word_bboxes: list[TensorBoundingBox] | None = None
    word_labels: list[TensorLabel] | None = None
    segment_level_bboxes: list[TensorBoundingBox] | None = None
...
class TensorVisualQuestionAnswerGT(TensorDataModel["VisualQuestionAnswerGT"]):
    ...
    qa_pair: TensorQuestionAnswerPair
    words: list[str]
    word_bboxes: list[TensorBoundingBox]
    segment_level_bboxes: list[TensorBoundingBox]
...
class TensorLayoutAnalysisGT(TensorDataModel["LayoutAnalysisGT"]):
    ...
    annotated_objects: list[TensorAnnotatedObject] | None = None
    words: list[str] | None = None
    word_bboxes: list[TensorBoundingBox] | None = None
